...
<head>
	...
	<title>College Siksha</title>
</head>
</head>
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
		<a class="navbar-brand" href="home.php">
    	<img src="jagran_logo1.jpg" width="30" height="30" class="d-inline-block align-top" alt=""> College Dunia
  		</a>
  <!-- Links -->
	...
	<div class="background">
		...
		<form method="post" action="home.php">
			<div id="center">
				...
				<input class="ip" type="text" name="srm" placeholder="SRMJEE Score"><br><br>
